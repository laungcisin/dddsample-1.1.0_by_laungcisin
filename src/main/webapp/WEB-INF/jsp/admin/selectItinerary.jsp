        ...
        <form action="${postUrl}" method="post">
            ...
            <table>
                ...
                <c:forEach items="${it.legs}" var="leg" varStatus="legStatus">
                    ...
                    <input type="hidden" name="legs[${legStatus.index}].fromDate"
                           value="<fmt:formatDate value="${leg.loadTime}" pattern="yyyy-MM-dd hh:mm"/>"/>
                    <input type="hidden" name="legs[${legStatus.index}].toDate"
                           value="<fmt:formatDate value="${leg.unloadTime}" pattern="yyyy-MM-dd hh:mm"/>"/>
                    <tr>
